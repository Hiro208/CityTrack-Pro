              ...
              <div className="max-h-48 overflow-auto space-y-2">
                {notificationCenter.slice(0, 20).map((n) => (
                  <button
                    ...
                    className={`w-full text-left text-[10px] border-l-2 pl-2 py-1 transition hover:bg-yellow-500/15 ${
                      n.is_read
                  ...
                  >
                    ...
                    <div className="mt-0.5 text-[9px] opacity-70">
                      {n.email_sent ? 'Email sent' : 'Email pending'}
                    </div>
                  </button>
                ))}
              </div>
          ...
          >
            <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-yellow-500/20 bg-neutral-900/95 px-5 py-4 backdrop-blur">
              <div>
                <div className="text-xs uppercase tracking-wider text-yellow-300/80">
                  {selectedNotification.effect_text || 'Service Alert'}
                </div>
            ...
            <div className="space-y-4 px-5 py-4 text-sm text-yellow-100/95">
              ...
              <div className="text-xs text-yellow-200/80">
                <div>
                  {selectedNotification.email_sent ? 'Email sent' : 'Email pending'}
                </div>
                <div className="mt-1">
